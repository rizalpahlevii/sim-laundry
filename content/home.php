            ...
            <div class="col-xl-4 col-sm-6 mb-4">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <?php 
                    $row_plg = $db->get("*","pelanggan","ORDER BY kode_pelanggan ASC")->rowCount();
                   ?>
                  <h3 style="margin-bottom: -12px;"><?php echo $row_plg; ?></h3>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="index.php?p=pelanggan">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-4 col-sm-6 mb-4">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Petugas</div>
                  <?php 
                    $row_ptg = $db->get("*","petugas","ORDER BY kode_PTG ASC")->rowCount();
                    
                   ?>
                  <h3 style="margin-bottom: -12px;"><?php echo $row_ptg; ?></h3>
                </div>
